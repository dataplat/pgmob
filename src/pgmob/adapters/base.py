...
class BaseCursor(ABC):
    ...
    @abstractmethod
    def executemany(self, query: Composable, params: Sequence[tuple] | None = None) -> None:
    ...
    @abstractmethod
    def mogrify(self, query: Composable, params: tuple | None = None) -> bytes:
    ...
    def scalar(self, query: Composable, params: tuple | None = None) -> Any:
